...
namespace Vetores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine ($"vertor01 [{indice}] = {vetor01[indice]} ");
            }
            ...
            {
                Console.WriteLine($"vertor02 [{indice}] = {vetor02[indice]} ");               
            }
            ...
            {
                Console.WriteLine($"vertor03 [{indice}] = {vetor03[indice]} ");
            }
